...
### ~~3. `program-build-deploy`~~ ГОТОВО

Сделано коллегой. Программа задеплоена на devnet:
...
Все конфиги обновлены. CI pipeline активен.
...
| 3 | `program-build-deploy`        | program   | ГОТОВО      | ~~Маленькая~~ |
| 4 | `devnet-bootstrap-script`     | scripts   | ГОТОВО      | ~~Средняя~~ |
| 5 | `backend-payment-flow`        | backend   | ГОТОВО      | ~~Большая~~ |
| 6 | `frontend-wallet-verification`| frontend  | ГОТОВО      | ~~Маленькая~~ |
| 7 | `frontend-chain-integration`  | frontend  | ГОТОВО      | ~~Большая~~ |
| 8 | `integration-tests`           | program   | Заблокирован| Средняя     |
| 9 | `ui-polish`                   | все       | ГОТОВО      | ~~Маленькая~~ |
