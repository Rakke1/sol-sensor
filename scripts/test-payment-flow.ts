#!/usr/bin/env tsx
/**
 * End-to-end test for the backend payment flow.
 *
 ...
 *
 * Usage:
 *   npx tsx test-payment-flow.ts [backend-url]
 */
...
async function main(): Promise<void> {
  console.log('\n🧪 SolSensor Payment Flow E2E Test\n');
  ...
  if (!usdcMintStr) {
    throw new Error('No USDC mint found — run bootstrap-devnet.ts first');
  }
